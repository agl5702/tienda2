                ...
                <div className="col-md-3 mb-3">
                  <div className="card border-primary h-100">
                    ...
                    <div className="card-body">
                      ...
                      <p className="text-muted text-center mb-0">
                        {formatCurrency(reportData.metrics.average_profit_per_day)} diario
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-3 mb-3">
                  <div className="card border-info h-100">
                    ...
                    <div className="card-body">
                      ...
                      <p className="text-muted text-center mb-0">
                        {(reportData.metrics.total_products_sold / reportData.metrics.days_with_sales).toFixed(1)} diario
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="card-body" style={{ height: '400px' }}>
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            ...
                            />
                            <Legend />
                            <Bar dataKey="ganancias" fill="#4e73df" name="Ganancias" />
                            <Bar dataKey="neto" fill="#1cc88a" name="Neto" />
                            <Bar dataKey="devoluciones" fill="#e74a3b" name="Devoluciones" />
                          </BarChart>
                        </ResponsiveContainer>
                      </div>
                    </div>
                ...
                <div className="card-body">
                  <div className="table-responsive">
                    <table className="table table-sm">
                      ...
                      <tbody>
                        {Object.entries(reportData.earnings.daily_earnings).map(([date, data], index) => (
                          <tr key={index}>
                            <td>{date}</td>
                            <td className="text-end">{formatCurrency(data.total_profit_day)}</td>
                            <td className="text-end">{formatCurrency(data.total_returns_day)}</td>
                            <td className="text-end">{formatCurrency(data.net_profit_day)}</td>
                            <td className="text-end">
