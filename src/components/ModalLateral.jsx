...
const SideMenu = () => {
  ...
  return (
    <div>
      <button
        onClick={toggleMenu}
        className={`menu-button btn px-3 ${isOpen ? "d-none" : ""}`}
      ...
      <div ref={menuRef} className={`side-menu ${isOpen ? "open" : ""}`}>
        <div className="menu-content">
          ...
          >
            <NavLink
              to="/"
              className="border-bottom text-center mt-2 mb-1 pb-2 position-sticky"
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span
                    className={isActive ? "selector" : "no-selector"}
                  ></span>
                </>
              )}
            </NavLink>
            ...
            <div className="my-1 p-1 text-center mt-auto card-menu mx-2">
              <button
                ...
                className="btn btn-sm border m-0 ms-n1"
              >
                <MdFullscreen
                  size={20}
                  color="white"
